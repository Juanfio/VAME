...
## Running VAME, step-by-step

In this tutorial we will show you how to run the VAME workflow step-by-step using a simple example. The code below can also be found in the `demo.py` script in our Github repository ([link here](https://github.com/EthoML/VAME/blob/main/examples/demo.py)).


### 0. Download the necessary resources:
